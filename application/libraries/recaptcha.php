...
class Recaptcha
{
	var $publickey  = '6LcTRcISAAAAAOytqIinVaBttL7zBhkcW7iHb4_E';
	var $privatekey = '6LcTRcISAAAAALMYXCiYDiTNbNybwouDxs5thUrs';
	var $error = null;
	...
	function validate(){
		if (isset($_POST["recaptcha_response_field"])) {
		        $resp = $this->recaptcha_check_answer ($this->privatekey,
		                                        $_SERVER["REMOTE_ADDR"],

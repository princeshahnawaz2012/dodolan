    ...
    return this.each( function() {
        ...
        dirOptions = {
			"bo" : function(){
				...
				d.first.top =  (flipObj.top+(flipObj.height/1));
				d.start.borderBottomWidth = 0;
			...
			"bc" : function(){
	            ...
	            d.second.borderBottomWidth = 0;
		        d.second.borderBottomColor= flipObj.bgColor;
			//	d.second.top = (flipObj.top+(flipObj.height/2);
              //  d.second.left = (flipObj.left-waist);
                return d;
			},
